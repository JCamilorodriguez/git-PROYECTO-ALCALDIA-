<?php
	class Modelo_documento
	{
		...
		function Registrar_documento($iddocumento,$asunto,$idtipodocu,$idarea,$idremitente,$idusuario,$tiemporespuesta,$opcion,$destinoImagen,$cont){
			$sql = "call PA_REGISTRARDOCUMENTOARCHIVO('$iddocumento','$asunto','$idtipodocu','$idarea','$idremitente','$idusuario','$tiemporespuesta','$opcion','$destinoImagen','$cont')";
