...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-01-2022 a las 02:01:55
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_REGISTRARDOCUMENTOARCHIVO` (IN `iddocumento` CHAR(13), IN `asunto` VARCHAR(150), IN `idtipodocu` INT, IN `idarea` INT, IN `idremitente` INT, IN `idusuario` INT, IN `tiemporespuesta` INT, IN `opcion` VARCHAR(10), IN `archivo` VARCHAR(350), IN `cont` INT)  BEGIN
IF cont = 0 THEN
	INSERT INTO documento (documento_cod,doc_asunto,tipoDocumento_cod,area_cod,usu_cod,doc_estado,doc_tipo,tiempo_respuesta) VALUES
(iddocumento,asunto,idtipodocu,idarea,idusuario,'PENDIENTE',opcion,tiemporespuesta);
END IF;
IF cont = 1 THEN
	INSERT INTO documento (documento_cod,doc_asunto,tipoDocumento_cod,area_cod,usu_cod,doc_estado,doc_tipo,doc_documento,tiempo_respuesta) VALUES
(iddocumento,asunto,idtipodocu,idarea,idusuario,'PENDIENTE',opcion,archivo,tiemporespuesta);
END IF;
IF opcion = 'C' THEN
		INSERT INTO detalle_ciudadano (ciudadano_cod,documento_cod) VALUES (idremitente,iddocumento);
END IF;
...
(1, 'SECRETARIA GENERAL ', '2018-11-21 07:54:25', 'ACTIVO'),
(2, 'DIRECCION', '2018-11-21 08:41:19', 'ACTIVO'),
(3, 'DESPACHO DEL ALCALDE ', '2022-01-04 17:11:09', 'ACTIVO'),
(4, 'DIRECCION ADMINISTRATIVA TALENTO HUMANO ', '2022-01-04 17:17:54', 'ACTIVO'),
(5, 'COMISARIA DE FAMILIA ', '2022-01-04 17:20:07', 'ACTIVO'),
(6, 'INSPECCION DE POLICIA ', '2022-01-04 17:24:27', 'ACTIVO'),
(7, 'SECRETARIA DE PLANEACION Y DESARROLLO ECONOMICO ', '2022-01-04 17:29:42', 'ACTIVO'),
(8, 'SECRETARIA HACIENDA Y TESORERIA', '2022-01-04 17:31:16', 'ACTIVO'),
(9, 'SECRETARIA DE GESTION Y ACCION SOCIAL ', '2022-01-04 17:38:43', 'ACTIVO'),
(10, 'DIRECCION DE DEPORTE Y  CULTURA ', '2022-01-04 17:42:37', 'ACTIVO'),
(11, 'DIRECCION DE PROMOCION AGROPECUARIA Y AMBIENTAL', '2022-01-04 17:47:23', 'ACTIVO');
...
INSERT INTO `documento` (`documento_cod`, `doc_asunto`, `doc_fecha_recepcion`, `tipoDocumento_cod`, `area_cod`, `usu_cod`, `doc_estado`, `doc_tipo`, `doc_documento`, `tiempo_respuesta`) VALUES
('DOC-000001', 'CCC', '2018-11-25 08:58:48', 3, 2, 1, 'ACEPTADO', 'C', 'Archivo/5bfa64483dd0d-modelado.pdf', 0),
('DOC-000002', 'PROFORMAS', '2018-11-27 00:45:11', 3, 1, 1, 'ACEPTADO', 'C', 'Archivo/5bfc93978495c-modelado.pdf', 0),
('DOC-000003', 'GDGGG', '2022-01-06 14:15:20', 6, 11, 1, 'RECHAZADO', '', 'Archivo/61d6f978a4124-Modelo-de-incidente-de-desacato.doc', 0),
('DOC-000004', '56654', '2022-01-06 17:32:23', 14, 10, 1, 'ACEPTADO', '', NULL, 0),
('RAD 2022-0000', 'SDSDDD', '2022-01-13 18:58:23', 14, 11, 1, 'RECHAZADO', '', NULL, 1),
('RAD-000005', 'WGTERR', '2022-01-10 20:46:41', 16, 11, 1, 'ACEPTADO', '', NULL, 0),
('RAD-000006', 'FFEERERE', '2022-01-10 21:38:55', 4, 9, 1, 'RECHAZADO', '', NULL, 10),
('RAD-000007', 'FEEWETRER', '2022-01-10 21:39:26', 16, 11, 1, 'ACEPTADO', '', NULL, 3),
('RAD2022-00000', 'FSDFSDFSDFS', '2022-01-13 19:02:36', 16, 11, 1, 'PENDIENTE', '', NULL, 1),
('RAD2022-00001', 'SSDSDSD', '2022-01-13 19:03:35', 15, 9, 1, 'ACEPTADO', '', NULL, 1);
...
(1, 'PEDRONEL', 'AVELLA ', 'LOPEZ', '7777', 'M', '1996-01-29', 'MI CASA', '111111', '982255930', 'janiro_avila@gmail.com', '2018-11-14 07:27:52', 'ACTIVO', 1, 'DIRECTOR'),
(8, 'secretaria ', 'ASISTENTE', 'ASISTENTE', '73340318', 'M', '1996-07-04', 'NI IDEA', '982255930', '043506219', 'SUCASI@GMAIL.COM', '2018-11-23 11:22:20', 'ACTIVO', 10, 'SECRETARIA'),
(9, 'CAMILO ', 'RODRIGUEZ', 'CALDERON ', '12114910', 'M', '1998-08-14', '344DE', '311554557', '115555', 'rodriguez20150910@gmail.com', '2022-01-11 17:25:15', 'ACTIVO', 11, 'SECRETARIA');
...
(1, 'ORGANISMOS  DE CONTROL ', 'ACTIVO'),
(2, 'CONSULTAS', 'ACTIVO'),
(3, 'PETICION DE DOCUMENTOS', 'ACTIVO'),
(4, 'DERECHOS DE PETICION ', 'ACTIVO'),
(5, 'ENTIDADES GUBERNAMENTALES  ', 'ACTIVO'),
(6, 'QUEJAS  ', 'ACTIVO'),
(7, 'RECLAMOS ', 'ACTIVO'),
(8, 'SUGERENCIAS', 'ACTIVO'),
(9, 'OTROS SIN NESESIDAD DE RESPUESTA ', 'ACTIVO'),
(10, 'DESPACHO COMISARIOS ', 'ACTIVO'),
(11, 'TUTELA ', 'ACTIVO'),
(12, 'QUERREÑA POLICIVA ', 'ACTIVO'),
(13, 'NOTIFICACIONES ', 'ACTIVO'),
(14, 'INFORMATIVO ', 'ACTIVO'),
(15, 'REPORTES Y DENUNCIAS ', 'ACTIVO'),
(16, 'RECURSOS DE REPOSICION Y APELACION ', 'ACTIVO');
...
(11, 'tesoreria', '123456789', 'ACTIVO', 2, 'Fotos/admin.png');
...
--
ALTER TABLE `tipo_documento`
  MODIFY `tipodocumento_cod` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Codigo auto-incrementado del tipo documento', AUTO_INCREMENT=17;
